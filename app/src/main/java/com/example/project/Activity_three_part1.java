...
public class Activity_three_part1 extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_three_details);
    ...
    private void showAlertDialog () {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Activity_three_part1.this);
        ...
        alertDialog.setMultiChoiceItems(items, checkedItems, new DialogInterface.OnMultiChoiceClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                switch (which) {
                    case 0:
                        if (isChecked) {
                            Toast.makeText(Activity_three_part1.this, "Done", Toast.LENGTH_LONG).show();
                            final Database p = new Database((long) 0, "Chilli Chicken", "yes", "no");
                            // FavList.add(p);
                            dbManager.insert(p);
                    ...
                    case 1:
                        if (isChecked) {
                            Toast.makeText(Activity_three_part1.this, "Not Added", Toast.LENGTH_LONG).show();
                            final Database p = new Database((long) 0, "Chilli Chicken", "no", "yes");
                            dbManager.insert(p);

                            Intent ShowIntent = new Intent(Activity_three_part1.this, Fav_List.class);
