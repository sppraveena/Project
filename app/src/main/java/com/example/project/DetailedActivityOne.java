...
public class DetailedActivityOne extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detailed_two);
  ...
  mLoadingText1=(TextView) findViewById(R.id.textView1);
    ...
    private void showAlertDialog() {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(DetailedActivityOne.this);
        ...
        alertDialog.setMultiChoiceItems(items, checkedItems, new DialogInterface.OnMultiChoiceClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                        switch (which) {
                            case 0:
                                if(isChecked) {
                                    Toast.makeText(DetailedActivityOne.this, "Done", Toast.LENGTH_LONG).show();
                                    final Database p = new Database((long) 0, "Biryani", "yes", "no");
                                   // FavList.add(p);
                                    dbManager.insert(p);
                            ...
                            case 1:
                            if(isChecked) {
                                Toast.makeText(DetailedActivityOne.this, "Not Added", Toast.LENGTH_LONG).show();
                                final Database p = new Database((long) 0, "Biryani", "no", "yes");
                                dbManager.insert(p);

                                Intent ShowIntent = new Intent(DetailedActivityOne.this, Fav_List.class);
