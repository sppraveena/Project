...
public class Activity_two_part1 extends AppCompatActivity {
    ...
    private void showAlertDialog () {
        final AlertDialog.Builder alertDialog = new AlertDialog.Builder(Activity_two_part1.this);
        ...
        alertDialog.setMultiChoiceItems(items, checkedItems, new DialogInterface.OnMultiChoiceClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which, boolean isChecked) {
                switch (which) {
                    case 0:
                        if (isChecked) {
                            Toast.makeText(Activity_two_part1.this, "Done", Toast.LENGTH_LONG).show();
                    ...
                    case 1:
                        if (isChecked) {
                            Toast.makeText(Activity_two_part1.this, "Not Added", Toast.LENGTH_LONG).show();
                            final Database p = new Database((long) 0, "Biryani", "no", "yes");
                            dbManager.insert(p);

                            Intent ShowIntent = new Intent(Activity_two_part1.this, Fav_List.class);
